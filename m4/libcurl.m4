# LIBCURL_CHECK_CONFIG ([DEFAULT-ACTION], [MINIMUM-VERSION], [MAXIMUM-VERSION],
...
[
  ...
  if test "$_libcurl_with" != "no" ; then
     ...
     if test x$_libcurl_config != "x" ; then
        ...
        unset _libcurl_wanted_min
        unset _libcurl_wanted_max
     fi
...
if (x) ;
        ...
        if test $libcurl_cv_lib_curl_usable = yes ; then
           ...
           AC_SUBST(LIBCURL)
           AC_SUBST(LIBCURL_VERSION, $_libcurl_version)
